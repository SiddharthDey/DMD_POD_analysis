...
U1_mat = mat73.loadmat('/home/aritra/pod/2d_offsetData/Phi_DMD.mat')
U1 = U1_mat['Phi']
...
DMD_mode_u_real = np.real(U1[:217070,mode])
DMD_mode_u_imag = np.imag(U1[:217070,mode])
DMD_mode_v_real = np.real(U1[217070:,mode])
...
for j in range(217070):
    L_real = [str(DMD_mode_u_real[j]) + " " + str(DMD_mode_v_real[j]) + " " + str(0.0)]
